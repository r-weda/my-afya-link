      ...
      <div className="elevated-card rounded-2xl p-4 md:p-5 lg:p-6 space-y-3">
        ...
        >
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-lg bg-health-green/10 flex items-center justify-center">
              <Calendar className="w-4 h-4 text-health-green" />
            </div>
            <h4 className="font-display font-semibold text-sm text-card-foreground">Upcoming Visits</h4>
          </div>
      ...
      <div className="elevated-card rounded-2xl p-4 space-y-3">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <h4 className="font-display font-semibold text-sm text-card-foreground">Notifications</h4>
          </div>
          <ChevronRight className="w-4 h-4 text-muted-foreground" />
        </button>
