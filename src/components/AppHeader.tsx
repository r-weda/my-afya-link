...
import { Bell, Settings, LogOut, Shield, Home, FileText, Stethoscope, MapPin, Calendar, HeartPulse } from "lucide-react";
    ...
    <header className="sticky top-0 z-40 bg-background/80 backdrop-blur-xl border-b border-border/50 safe-top">
      <div className="flex items-center justify-between px-4 md:px-6 py-3 md:py-3.5 max-w-lg md:max-w-4xl lg:max-w-[1400px] mx-auto">
        <div className="flex items-center gap-2">
          <HeartPulse className="w-6 h-6 md:w-7 md:h-7 text-primary shrink-0" />
          <h1 className="font-display font-bold text-base md:text-xl lg:text-2xl text-foreground leading-none">
            {title || "AfyaConnect"}
          </h1>
        </div>
